...
class Category(models.Model):
	...
	def get_absolute_url(self):
		return ('weblog_category_detail', (), { 'slug':self.slug })
...
class Entry(models.Model):
	...
	#Need to be this way around so that non-live entries will show up in Admin, 
	#which uses the default (first) manager.
